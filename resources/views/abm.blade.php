...
@section('content')
  ...
  <div class="card text-center">
    ...
    <div class="col-5 float-right" style="font-size:20px">Questions </div><div class="col-2" style="font-size:20px">Category </div>
...
{{-- <input type="checkbox" name="" value=""> --}}
  ...
  @endforelse
    ...
    <select class="drop-down menu col-sm-4 " placeholder="Boolean" value="" name="vof">
      @if (isset($question))
        @if ($question->value=="1")
          <option value="1" selected>Verdadero (1)</option>
        @else
          <option value="1">Verdadero (1)</option>
        @endif
        @if ($question->value=="0")
        <option value="0" selected>Falso (0)</option>
        @else
